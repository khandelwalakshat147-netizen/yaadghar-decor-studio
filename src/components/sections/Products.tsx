...
const products: Product[] = [
  ...
  { name: "Rectangular Magnet", size: "3x4 inch", shape: "Rectangle", price: "Custom Pricing", img: rect, custom: true },
  { name: "Premium Magnet", size: "4x4 inch", shape: "Square", price: "₹149", priceSub: "– ₹199", img: large },
  { name: "XL Magnet", size: "4x6 inch", shape: "Rectangle", price: "Custom Pricing", img: rect, custom: true },
];
